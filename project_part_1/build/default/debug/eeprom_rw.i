...
void recoverData(){
    ...
    if(DATAEE_ReadByte(0xF0FF - 10) == 0xAB){
        if(DATAEE_ReadByte(0xF0FF) == cksum()){
            ...
            temp_thresh = DATAEE_ReadByte(0xF0FF - 10 + 5);
            lum_thresh = DATAEE_ReadByte(0xF0FF - 10 + 6);
            pmon = DATAEE_ReadByte(0xF0FF - 10 + 7);
            tala = DATAEE_ReadByte(0xF0FF - 10 + 8);
        }
    }
    ...
    DATAEE_WriteByte(0xF0FF - 10 + 7, pmon);
    DATAEE_WriteByte(0xF0FF - 10 + 8, tala);
    cksum_w();
}
