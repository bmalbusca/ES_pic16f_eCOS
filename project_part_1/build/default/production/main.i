...
# 29 "./mcc_generated_files/drivers/i2c_simple_master.h" 2
        ...
        if(t5s >= pmon){
            ...
            do{
                    if(!config_mode){
                        ...
                        config_routine();
                        (PIE0bits.INTE = 1);
                        DATAEE_WriteByte(0xF0FF - 10 + 5, temp_thresh);
                        DATAEE_WriteByte(0xF0FF - 10 + 6, lum_thresh);
                    }
...
unsigned char checkDebounceSW2(){
    ...
    if(clkms - last_ms2 < 0){
        ...
        if ((200 - last_ms2)+ clkms > 15 ){
            last_ms2 = clkms;
            return 1;
        }
    }

    if(clkms - last_ms2 < 15){
        return 0;
    }else{
        last_ms2 = clkms;
        return 1;
